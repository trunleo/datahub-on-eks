...
sqlcmd -U %USER_DB% -P "%PASSWD_DB%" -Q "BACKUP LOG %DB_NAME% TO DISK='%FILE_BACKUP_PATH%' WITH DIFFERENTIAL,INIT, COMPRESSION"
...
aws s3 cp %FILE_BACKUP_PATH% s3://%BUCKET_NAME%/DIGITAL-DB/DIFF/%BACKUP_FILE_NAME% --cli-connect-timeout 6000 
